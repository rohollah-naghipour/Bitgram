...
class RequestsListView(APIView):
    def get(self, request):
        ...
        #print(list_users)
        serializer_1 = UserListSerializer(list_users, many=True)
        serializer_2 = FriendshipSerializer(requests, many=True)
        #return(Response({erializer_1.data)}serializer_1.data))
        return(Response({'serializer_1': serializer_1,
                         'serializer_2': serializer_2}))   
